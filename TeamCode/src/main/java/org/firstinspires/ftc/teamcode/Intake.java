 ...
 * behavior here (sensor checks, sequencing, etc.) once the mechanism design is settled — see
 * ShooterSystem/IntakeSystem from last year's code for the kind of pattern to follow.
 */
public class Intake {
